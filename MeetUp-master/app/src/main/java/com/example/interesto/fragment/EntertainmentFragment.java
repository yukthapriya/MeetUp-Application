...
public class EntertainmentFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerViewEnter=view.findViewById(R.id.recyclerviewofentertainment);
        ...
        recyclerViewEnter.setAdapter(newsCardAdapter);
    ...
    {
        ApiUtilities.getApiInterface().getNewsByCategory(country,"entertainment",100,API_KEY).enqueue(new Callback<MainNews>() {
            @Override
