...
public class TechnologyFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerViewTech=view.findViewById(R.id.recyclerviewoftechnology);
        ...
        recyclerViewTech.setAdapter(newsCardAdapter);
    ...
    {
        ApiUtilities.getApiInterface().getNewsByCategory(country,"technology",100,API_KEY).enqueue(new Callback<MainNews>() {
            @Override
