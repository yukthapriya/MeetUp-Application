...
public class HealthFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerViewHealth=view.findViewById(R.id.recyclerviewofhealth);
        ...
        recyclerViewHealth.setAdapter(newsCardAdapter);
    ...
    {
        ApiUtilities.getApiInterface().getNewsByCategory(country,"health",100,API_KEY).enqueue(new Callback<MainNews>() {
            @Override
